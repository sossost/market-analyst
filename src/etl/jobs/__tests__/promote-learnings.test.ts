...
vi.mock("@/lib/statisticalTests", () => ({
  binomialTest: vi.fn().mockReturnValue({ isSignificant: true, pValue: 0.01, cohenH: 0.5 }),
}));
...
describe("getPromotionThresholds", () => {
  it("활성 학습 0건(cold start) — 완화 기준 반환", () => {
