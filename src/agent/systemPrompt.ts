...
📋 **부록: 종목 상세** — 본문의 거시적 흐름을 먼저 읽은 뒤, 개별 종목 드릴다운이 필요할 때 참조

6. **특이종목 상세** — ⭐ 강세(거래량 2x 이상 동반)와 ◎ 강세(미동반) 구분. ⚠️ 약세 특이종목: 급락 원인 분석 → 보유 시 리스크 경고
7. **주도주 예비군** — Phase 1 후기 + RS 상승 초기 종목 상세 (MA150 기울기, 섹터 RS, 거래량 추세)
