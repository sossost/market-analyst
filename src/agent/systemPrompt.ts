...
3. **주도주 예비군 상세** — Phase 1 후기 + RS 상승 초기 종목 심층 분석 (MA150 기울기, 섹터 강도, 실적 가속 패턴, 전환 시나리오)
4. **장관 토론 전망** — ACTIVE theses 중 주요 전망 요약 + 이번 주 종목 선정에 미친 영향
5. **펀더멘탈 검증 요약** — 전체 등급 분포표 (S/A/B/C/F 종목수)
6. **추천 성과 트래킹** — 활성 추천 현황, 종료된 추천 결과
